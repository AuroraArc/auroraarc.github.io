    ...
    <div className="fade-in h-screen bg-base-100 p-4 lg:p-10">
      ...
      <div className="italic-section mx-auto max-w-screen-lg">
        <p className="text-base-content text-opacity-50 mt-2 italic opacity">
            This is a compilation of a symposium presentation I gave on the topic of my research and the surrounding background regarding quantum chemistry and its computational challenges.
            {/* The project is closed-source, so I unfortunately cannot share any code. */}
        </p>
      </div>
      <div className="project-content mt-6">
        ...
        <figure className="text-center mt-2">
          <img src={edgeconv} alt="edgeconv" className="mx-auto my-4" style={{ width: '400px', height: '250px '}} />
        </figure>
        <p className="text-base-content text-opacity-70 mt-2">
        ...
        <figure className="text-center mt-2">
          <img src={graphpc} alt="graph-pc" className="mx-auto my-4" style={{ width: '400px', height: '250px '}} />
          <figcaption className="text-base-content text-opacity-70 mt-2 small-font" style={{ display: 'block', width: 'inherit', textAlign: 'left' }}>

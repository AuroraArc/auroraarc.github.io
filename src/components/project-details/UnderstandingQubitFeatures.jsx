...
const UnderstandingQubitFeatures = () => {
  ...
  return (
    <div className="fade-in h-screen bg-base-100 p-4 lg:p-10">
      ...
      <div className="italic-section text-left mx-auto max-w-screen-lg">
      ...
      <div className="project-content mt-6 text-left mx-auto max-w-screen-lg">
        ...
        <p className="text-base-content text-opacity-70 text-left mt-2">
        ...
        <ul className="text-base-content text-opacity-70 text-left mt-2">

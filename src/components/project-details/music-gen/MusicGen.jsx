    ...
    <div className="fade-in h-screen bg-base-100 p-4 lg:p-10">
      ...
      <div className="italic-section mx-auto max-w-screen-lg">
        <p className="text-base-content text-opacity-50 mt-2 italic opacity">
          The current code is slightly outdated and is broken at the moment. There is an older version of the project that instead used a genetic algorithm with a GRU-based model for music generation. This can be viewed <Link to="/projects/music-generation-using-gga" className="text-blue-500 underline">here</Link>.
        </p>
      </div>

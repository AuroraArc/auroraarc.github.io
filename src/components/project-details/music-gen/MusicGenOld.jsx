  ...
  return (
    <div className="fade-in h-screen bg-base-100 p-4 lg:p-10">
      ...
      <div className="project-content mt-6 mx-auto max-w-screen-lg">
        ...
        <ol className="list-disc list-inside text-base-content text-opacity-70 mt-2">
        ...
        <ul className="list-disc list-inside text-base-content text-opacity-70 mt-2">
          <li><strong>Dual-Voice Compositions:</strong><br />The dataset includes compositions with two distinct voices—a treble line and a bass line—introducing the need to manage interactions between the voices and their harmonies.</li>
          <li><strong>Inclusion of Diverse Musical Elements:</strong><br />Beyond notes, the dataset incorporates rests, chords, and other musical features. This added complexity requires the system to account for a wider range of musical components, significantly increasing the difficulty of both training and evaluation.</li>
          <li><strong>Longer Melodies:</strong><br />The compositions in our dataset are substantially longer than those analyzed in related studies, challenging the system's ability to efficiently process, learn, and generate music at a comparable scale.</li>
        </ul>
        <p className="text-base-content text-opacity-70 mt-2">

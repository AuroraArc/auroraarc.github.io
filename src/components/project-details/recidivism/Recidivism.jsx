  ...
  return (
    <div className="fade-in h-screen bg-base-100 p-4 lg:p-10">
      ...
      <div className="project-content mt-6 mx-auto max-w-screen-lg">
        ...
        <p className="text-base-content text-opacity-70 mt-2">
          Based on these findings, the authors formulated four major recommendations to reduce recidivism rates and associated costs:
        </p>
        <ul className="text-base-content text-opacity-70 mt-2 list-disc ml-6">
          <li>Address Prison Overpopulation: Given the significant correlation between prison overpopulation and recidivism rates, the authors propose that the Iowa Department of Justice increase its implementation of alternative correctional programs, such as probation and community service, and reduce the use of mandatory minimums and determinate sentencing in the Iowa state code.</li>

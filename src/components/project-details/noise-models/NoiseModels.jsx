    ...
    <div className="fade-in h-screen bg-base-100 p-4 lg:p-10">
      ...
      <div className="project-content mt-6 mx-auto max-w-screen-lg">
        ...
        <div className="text-base-content text-opacity-70 mt-2">
          <p className="hanging-indent">[1] McDonnell, Mark D, and Derek Abbott. “What is stochastic resonance? Definitions, misconceptions, debates, and its relevance to biology.” PLoS computational biology vol. 5,5 (2009): e1000348. <a href="https://doi.org/10.1371/journal.pcbi.1000348" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://doi.org/10.1371/journal.pcbi.1000348</a></p>
          <p className="hanging-indent">[2] scikit-learn documentation. Version 1.4.2. <a href="https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html</a></p>
          <p className="hanging-indent">[3] Qiskit Machine Learning. Version 0.7.2 <a href="https://qiskit-community.github.io/qiskit-machine-learning/" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://qiskit-community.github.io/qiskit-machine-learning/</a></p>
          <p className="hanging-indent">[4] Qiskit documentation. Version Version 1.0.2 <a href="https://docs.quantum.ibm.com/api/qiskit" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://docs.quantum.ibm.com/api/qiskit</a></p>
          <p className="hanging-indent">[5] Nakanishi, Ken M., Keisuke Fujii, and Synge Todo. "Sequential minimal optimization for quantum-classical hybrid algorithms." Physical Review Research 2.4 (2020): 043158. <a href="https://doi.org/10.1103/PhysRevResearch.2.043158" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://doi.org/10.1103/PhysRevResearch.2.043158</a></p>
          <p className="hanging-indent">[6] Huang, Chenyi, and Shibin Zhang. ‘Enhancing Adversarial Robustness of Quantum Neural Networks by Adding Noise Layers’. New Journal of Physics, vol. 25, no. 8, IOP Publishing, Aug. 2023, p. 083019, <a href="https://doi.org/10.1088/1367-2630/ace8b4" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://doi.org/10.1088/1367-2630/ace8b4</a></p>
        </div>
      </div>
